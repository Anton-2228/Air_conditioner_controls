...
BOILER_TIMER_DELAY_MESSAGE = _read("boiler_timer_delay_message.txt")
BOILER_TIMER_DURATION_MESSAGE = _read("boiler_timer_duration_message.txt")
BOILER_TIMER_BAD_INPUT_MESSAGE = _read("boiler_timer_bad_input_message.txt")
